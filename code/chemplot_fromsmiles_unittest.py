...
class TestFromSmilesR(unittest.TestCase):
    ...
    def test_target_type_assigned_tailored(self):
        ...
        self.assertEqual(cp.target_type, "R")
    ...
    def test_sym_type_assigned_tailored(self):
        ...
        """
        cp = Plotter.from_smiles(self.data_LOGS["smiles"], target=self.data_LOGS["target"], target_type="R", sim_type="tailored")
        self.assertEqual(cp.sim_type, "tailored")
    ...
    def test_df_descriptors_created_tailored(self):
        ...
        """
        cp = Plotter.from_smiles(self.data_LOGS["smiles"], target=self.data_LOGS["target"], target_type="R", sim_type="tailored")
        self.assertNotIsInstance(cp.df_descriptors, type(None))
    ...
    def test_df_descriptors_non_empty_tailored(self):
        ...
        """
        cp = Plotter.from_smiles(self.data_LOGS["smiles"], target=self.data_LOGS["target"], target_type="R", sim_type="tailored")
        self.assertTrue(len(cp.df_descriptors) > 0)
    ...
    def test_sym_type_assigned_structural(self):
        ...
        """
        cp = Plotter.from_smiles(self.data_LOGS["smiles"], target=self.data_LOGS["target"], target_type="R", sim_type="structural")
        self.assertEqual(cp.sim_type, "structural")
...
class TestFromSmilesC(unittest.TestCase):
    ...
    def test_target_type_assigned_tailored(self):
        ...
        self.assertEqual(cp.target_type, "C")
...
class TestFromSmilesErroneusSMILES(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.data_BBBP_erroneous_smiles = pd.read_csv(".\Data\\test_data\\C_2039_BBBP_2_erroneous_smiles.csv") 
        cls.data_CLINTOX_2_erroneous_smiles = pd.read_csv(".\Data\\test_data\\C_1484_CLINTOX_2_erroneous_smiles.csv")
    ...
    def test_BBBP_erroneous_data_removed_tailored(self):
        ...
        self.assertEqual(len(cp.df_descriptors.index), len(self.data_BBBP_erroneous_smiles.index) - (len(self.list_BBBP_erroneous_smiles) + len(self.list_BBBP_erroneous_descriptors)))
    ...
    def test_CLINTOX_2_erroneous_data_removed_tailored(self):
        ...
        self.assertEqual(len(cp.df_descriptors.index), len(self.data_CLINTOX_2_erroneous_smiles.index) - (len(self.list_CLINTOX_2_erroneous_smiles) + len(self.list_CLINTOX_2_erroneous_descriptors)))
    ...
    def test_BBBP_erroneous_data_removed_structural(self):
        ...
        self.assertEqual(len(cp.df_descriptors.index), len(self.data_BBBP_erroneous_smiles.index) - len(self.list_BBBP_erroneous_smiles))
    ...
    def test_CLINTOX_2_erroneous_data_removed_structural(self):
        ...
        self.assertEqual(len(cp.df_descriptors.index), len(self.data_CLINTOX_2_erroneous_smiles.index) - len(self.list_CLINTOX_2_erroneous_smiles))
